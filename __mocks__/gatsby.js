...
module.exports = {
  ...
  mockMegaMap: new Map([
    [`meta[property="og:title"]`, `recipe-title`],
    [`meta[property="og:image"]`, `http://localhost:8000/recipe-public-url`],
    [
    ...
    [`meta[name="twitter:url"]`, `http://localhost:8000/Mock%20path`],
    [
  ...
  mockMegaMapAppendix: new Map([
    [`meta[property="og:title"]`, `recipe-title`],
    [`meta[property="og:image"]`, `http://localhost:8000/recipe-public-url`],
    [`meta[property="og:description"]`, `recipe-description`],
    [`meta[property="og:type"]`, `website`],
  ...
  mockMegaMapTag: new Map([
    [`meta[property="og:title"]`, `mock tag`],
    [`meta[property="og:image"]`, `http://localhost:8000/og-image-16x9.jpg`],
    [`meta[property="og:description"]`, `mock tag`],
    [`meta[property="og:type"]`, `website`],
